package com.example.acer.mobileshopdjj.utils;
...
public class SystemConfig {
    ...
    public static boolean isLogin(){ return SpTools.getBoolean(IS_LOGIN_KEY,false); }

    public static void setLogin(boolean isLogin){ SpTools.putBoolean(IS_LOGIN_KEY,isLogin);}

    public static String getLoginUserName(){ return SpTools.getString(LOGIN_USER_NAME_KEY,"");}

    public static void setLoginUserName(String userName){
        SpTools.putString(LOGIN_USER_NAME_KEY,userName);
    }

    public static String getLoginUserHead(){ return SpTools.getString(LOGIN_USER_HEAD_KEY,"");}

    public static void setLoginUserHead(String userHead){
        SpTools.putString(LOGIN_USER_HEAD_KEY,userHead);
    }

    public static String getLoginUserEmail(){ return SpTools.getString(LOGIN_USER_EMAIL_KEY,"");}
